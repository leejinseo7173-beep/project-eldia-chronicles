...
// 주인공 공통 화풍: 은빛 판금 + 금장식 + 흐르는 망토 (원화 기준)
export const HERO_KITS = {
  sword: {
    skills: { basic: 'hero_s_basic', actives: ['hero_s_a1', 'hero_s_a2'], sacred: 'hero_s_sacred' },
    passive: 'hero_s_p',
    assetKey: 'hero_sword',
    spriteCfg: { skin: 'peach', hair: 'tan', armor: 'gray4', armorDark: 'gray2', cloth: 'ink', weapon: 'sword', cape: 'blue', trim: 'gold' },
  },
  mage: {
    skills: { basic: 'hero_m_basic', actives: ['hero_m_a1', 'hero_m_a2'], sacred: 'hero_m_sacred' },
    passive: 'hero_m_p',
    spriteCfg: { skin: 'peach', hair: 'tan', armor: 'navy3', armorDark: 'navy2', cloth: 'navy1', weapon: 'staff', cape: 'blue', trim: 'gold' },
  },
  archer: {
    skills: { basic: 'hero_a_basic', actives: ['hero_a_a1', 'hero_a_a2'], sacred: 'hero_a_sacred' },
    passive: 'hero_a_p',
    assetKey: 'hero_archer',
    spriteCfg: { skin: 'peach', hair: 'tan', armor: 'gray4', armorDark: 'greenDark', cloth: 'forest', weapon: 'bow', cape: 'green', trim: 'gold' },
  },
};
...
export const CHARACTERS = {
  ...
  c01: {
    id: 'c01', name: '브란', classKey: 'knight', element: 'fire', grade: 3, assetKey: 'c01',
    skills: { basic: 'c01_basic', actives: ['c01_a1', 'c01_a2'] }, passive: 'c01_p',
    title: '부서진 맹세의 단장', intro: '…이 낡은 검이 아직 쓰일 곳이 있다면, 그대의 여명에 바치겠다. 브란 — 다시 한번, 서약하지.',
    spriteCfg: { skin: 'peach', hair: 'gray3', armor: 'gray4', armorDark: 'gray2', cloth: 'gray1', weapon: 'lance', shield: true, cape: 'red', trim: 'goldDark' },
  },
  c02: {
    id: 'c02', name: '카시안', classKey: 'mage', element: 'water', grade: 3, assetKey: 'c02',
    skills: { basic: 'c02_basic', actives: ['c02_a1', 'c02_a2'] }, passive: 'c02_p',
    title: '왕궁이 버린 현자', intro: '허물어진 왕국에 궁정 마법사라니, 서로 딱한 처지군요. …계약 성립입니다. 환불은 안 됩니다?',
    spriteCfg: { skin: 'peach', hair: 'gray4', armor: 'navy3', armorDark: 'navy2', cloth: 'navy1', weapon: 'staff', cape: 'blue', trim: 'skyBlue' },
  },
  c03: {
    id: 'c03', name: '세라핀', classKey: 'cleric', element: 'light', grade: 3, assetKey: 'c03',
    skills: { basic: 'c03_basic', actives: ['c03_a1', 'c03_a2'] }, passive: 'c03_p',
    title: '마지막 성녀', intro: '빛이 저를 이곳으로 이끌었나 봐요. 조금 지친 기도지만… 아직 따뜻해요. 세라핀이라고 합니다.',
    spriteCfg: { skin: 'peach', hair: 'gold', armor: 'white', armorDark: 'gray4', cloth: 'white', weapon: 'staff', cape: 'white', trim: 'gold' },
  },
  c04: {
    id: 'c04', name: '녹스', classKey: 'thief', element: 'dark', grade: 3,
    skills: { basic: 'c04_basic', actives: ['c04_a1', 'c04_a2'] }, passive: 'c04_p',
    title: '낙인 찍힌 그림자', intro: '…이건 계약이지, 신뢰가 아니다. 등 뒤는 맡겨라. 그 이상은 묻지 마. …녹스다.',
    spriteCfg: { skin: 'peach', hair: 'purple', armor: 'purpleDark', armorDark: 'ink', cloth: 'ink', weapon: 'dagger', cape: 'purpleDark', trim: 'purple' },
  },
  c05: {
