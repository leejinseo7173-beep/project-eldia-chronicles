# ============================================================
# build_wraith_knight.py — 망령 기사 전투 원화 13장 변환 (적 5호 — 마왕군 전원 완성)
#
#   assets/sprites/_source_wraith_knight/*.png  →  assets/sprites/c01/*.png (192×128)
#
...
SRC = os.path.join(ROOT, 'assets', 'sprites', '_source_wraith_knight')
OUT = os.path.join(ROOT, 'assets', 'sprites', 'wraith_knight')

W, H = 240, 128         # 기병창이 길어 가로 확장 (엔진 가변 폭 대응 — 브란 144 전례)
FOOT_ROW = 120
...
OFFX = {'walk3': 16, 'attack1': 16}   # 창을 왼쪽으로 길게 뻗는 프레임 잘림 방지
