# ============================================================
# build_shadow_stalker.py — 그림자 살수 전투 원화 13장 변환 (적 4호)
#
#   assets/sprites/_source_shadow_stalker/*.png  →  assets/sprites/c01/*.png (192×128)
#
...
SRC = os.path.join(ROOT, 'assets', 'sprites', '_source_shadow_stalker')
OUT = os.path.join(ROOT, 'assets', 'sprites', 'shadow_stalker')
...
OFFX = {'attack1': 12}   # 단검 왼쪽 휘두르기 잘림 방지
