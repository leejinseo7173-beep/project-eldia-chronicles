# ============================================================
# build_dark_shaman.py — 암흑 주술사 전투 원화 13장 변환 (적 3호)
#
#   assets/sprites/_source_dark_shaman/*.png  →  assets/sprites/c01/*.png (192×128)
#
...
SRC = os.path.join(ROOT, 'assets', 'sprites', '_source_dark_shaman')
OUT = os.path.join(ROOT, 'assets', 'sprites', 'dark_shaman')

W, H = 192, 128
FOOT_ROW = 120
CHAR_H = 112            # 해골 지팡이 포함 실측 절충 — 58은 지팡이 끝이 다수 잘린다
THICK = 8
...
OFFX = {'attack2': 16, 'attack0': 12}   # 지팡이 왼쪽 뻗는 프레임 잘림 방지
